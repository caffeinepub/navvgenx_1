...
export class Backend implements backendInterface {
    ...
    async addReminder(arg0: string, arg1: string, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async computeHealthScore(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.computeHealthScore();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrUpdateProfile(arg0: bigint, arg1: string, arg2: Array<string>, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getHealthEntries(): Promise<Array<HealthEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHealthEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleReminder(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleReminder(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
