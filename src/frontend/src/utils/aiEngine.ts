...
const greetingPatterns: { pattern: RegExp; response: string }[] = [
  ...
  },
  {
    ...
    response:
      "Hello! Welcome to NAVVURA AI. I'm your AI companion — ask me anything from science and history to life advice or just have a conversation. What would you like to explore?",
  },
  {
  ...
  },
  {
    ...
    response:
      "Good afternoon! I'm NAVVURA AI, your AI companion. Whether you need information, advice, or just someone to talk to, I've got you covered.",
  },
  {
  ...
  },
  {
    ...
    response:
      "I'm NAVVURA AI — a smart assistant inspired by the best of ChatGPT and Google Search. I can answer general knowledge questions, search any topic, give personal advice on health, career, love, and more, or just have a casual conversation with you!",
  },
  {
  ...
  },
  {
    ...
    response:
      "I'm an AI — NAVVURA AI to be precise. I'm not human, but I'm designed to be helpful, knowledgeable, and conversational. I can answer your questions, have a real discussion, or help you find information on virtually any topic.",
  },
];
...
export function detectContentCreation(query: string): string | null {
  ...
  <div style="background: oklch(0.10 0.020 265); color: oklch(0.78 0.15 75); padding: 20px; border-radius: 12px; margin-bottom: 12px; text-align: center;">
    ...
    <p style="opacity: 0.8; font-size: 13px; margin: 0;">A comprehensive presentation by NAVVURA AI</p>
  </div>
  ...
  <div style="background: oklch(0.10 0.020 265); color: oklch(0.78 0.15 75); padding: 16px; border-radius: 12px; text-align: center;">
    ...
    <p style="opacity: 0.8; font-size: 12px; margin: 0;">Generated by NAVVURA AI • Ask follow-up questions below</p>
  </div>
</div>`;
  }
...
export async function generateAIResponse(
  ...
  if (funnyResponse) {
    return {
      text: funnyResponse,
      sources: ["NAVVURA AI Comedy Club 🎭"],
      imageResults: [],
      searchResults: [],
      quickLinks: {
  ...
  if (recommendationAnswer) {
    ...
    return {
      ...
      suggestions,
      quickLinks,
      sources: ["NAVVURA AI Knowledge Base"],
    };
  }
