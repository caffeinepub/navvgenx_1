...
const greetingPatterns: { pattern: RegExp; response: string }[] = [
  ...
  },
  {
    ...
    response:
      "Hello! Welcome to NavvGenX AI. I'm your AI companion — ask me anything from science and history to life advice or just have a conversation. What would you like to explore?",
  },
  {
  ...
  },
  {
    ...
    response:
      "Good afternoon! I'm NavvGenX AI, your AI companion. Whether you need information, advice, or just someone to talk to, I've got you covered.",
  },
  {
...
**Quick start tip:** Start with freelancing or content creation — low cost, high potential!`,
  ...
  if (funnyResponse) {
    return {
      text: funnyResponse,
      sources: ["NavvGenX AI Comedy Club 🎭"],
      imageResults: [],
      searchResults: [],
      quickLinks: {
